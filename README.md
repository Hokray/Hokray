...
Computer Science student at **Trinity College Dublin** (2024–2028). I spent summer 2026 as a Business Intelligence Intern at PX, building data pipelines, automation and monitoring.

Interested in software engineering, data engineering, and systems close to the metal.
...
[**32-bit CPU Architecture**](https://github.com/Hokray/CPU-Scheme) — Solo project. A 32-bit CPU built in VHDL over three months: ALU, control unit, register file, instruction decoder, RAM/ROM and datapath, with a custom instruction set and testbench verification in Vivado. `VHDL` · `Vivado` · `ASM`
...
**Languages:** Python · Java · C · SQL · JavaScript · VHDL · ARM Assembly
**Data:** ClickHouse · PostgreSQL · Apache Airflow · pandas · Supabase · Power BI
**Tools:** Git · GitHub Actions · Vivado · Azure · Jira

## 📫 Connect

[LinkedIn](https://www.linkedin.com/in/hakan-okray-sinisterra)
